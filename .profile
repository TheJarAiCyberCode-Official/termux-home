# ============================================================================================= #
# FILE: ~/.profile - Skrip Inisialisasi Shell untuk Termux
# DESKRIPSI: Digunakan untuk mengatur variabel lingkungan (PATH) dan
#            melakukan setup awal direktori kerja (working directory) user.
# ============================================================================================= #
...
if [ ! -d "$USERDIR" ]; then
    ...
    # perintah resetuserdir diatur di ~/.bashrc
fi
