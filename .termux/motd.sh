...
# Ambil nama produsen dan model perangkat, lalu simpan dan gabungkan ke satu variabel
...
\e[1mInformasi Pembuatan Kernel:\e[0m $(uname -s -m -o)
\e[1mModel Produsen Perangkat:\e[0m ${DEVICE}
\e[1mRilis Versi APK Termux:\e[0m ${TERMUX_VERSION-Unknown} ${TERMUX_APK_RELEASE-Unknown}
"
